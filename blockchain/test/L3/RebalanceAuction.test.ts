...
async function deploy() {
  ...
  await vault.initializeRebalance(tokens, unitQty, "RB","RB", { manager: manager.address, meridian: meridian.address, treasury: treasury.address, managerFeeBps:200, platformShareBps:1000, keeperBps:250, keeperEscrow: await km.getAddress() });
