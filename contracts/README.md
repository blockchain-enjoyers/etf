...
This repo holds the Foundry contracts. Strategy and research live alongside (`state.md`, `plan.md`, `research/`, `docs/`). Full design: [`docs/specs/2026-06-03-meridian-contracts-architecture.md`](../docs/specs/2026-06-03-meridian-contracts-architecture.md) (at the monorepo root).
